...
if(salaaaaaaammmm == 1){redvalint = 255 ;greenvalint = 255 ; bluevalint = 0; 
}else if(salaaaaaaammmm == 2){redvalint = 0 ;greenvalint = 255 ; bluevalint = 255;  
}else if(salaaaaaaammmm == 3){redvalint = 255 ;greenvalint = 0 ; bluevalint = 255; }
